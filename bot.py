...
from handlers import start_handler, get_ogg_handler, no_file_message_handler, get_mp3_handler, get_wav_handler, archives_handler
...
async def main():
    ...
    dp.include_router(archives_handler.router)
