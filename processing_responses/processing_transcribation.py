...
async def processing_transcribation(transcribation) -> str:
    prompt = ("You are an expert in speech analysis and semantic linguistics."
        ...
        "The answer should be IN RUSSIAN LANGUAGE, concise and as specific as possible."
        "Do not write introductions or repeat the transcription text. Just give me 5 points of analysis."
        )
